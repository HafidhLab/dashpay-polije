                         ...
                         <form method="POST" action="{{ route('login') }}" class="mt-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <x-auth.text-input id="email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="example@gmail.com" />
                                    <x-auth.input-error :messages="$errors->get('email')" class="mt-2" />
                                </div>
                                <!-- Form -->
                                <div class="form-group mb-4">
                                    <label for="password">{{ __('Password') }}</label>
                                    <x-auth.text-input id="password" type="password" name="password" :value="old('password')" placeholder="****" required autofocus autocomplete="password" />
